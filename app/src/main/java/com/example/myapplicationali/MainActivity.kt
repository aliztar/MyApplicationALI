package com.example.myapplicationali
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_pindah_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Ali Mu'az")
...
private fun Intent.putExtra(extraData: String, data: Data) {
